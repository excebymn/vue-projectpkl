...
import { referenceTabs, referenceContent } from '@/data/portofolio/ReferensiData'
      ...
      <div class="card-body p-4">
        ...
        >
          <div class="container">
            ...
            <!-- ===================== -->
            <div class="text-center mb-5">
              <p class="text-warning fw-semibold text-uppercase small mb-2">Referensi Kegiatan</p>

              <h2 class="fw-bold mb-3">Dokumentasi & Aktivitas Program</h2>

              <p class="text-body-secondary mx-auto statistik-subtitle">
                Kumpulan dokumentasi kegiatan berdasarkan kategori pengembangan, pelatihan, dan
                ...
                <div class="card border shadow-sm h-100 statistik-card">
                  <div class="card-body p-4">
                    ...
                    <div v-if="item.type === 'image'">
                      ...
                      <p v-if="item.caption" class="text-muted small mb-0">
                        {{ item.caption }}
                      </p>
                    </div>
                    ...
                    <!-- PDF -->
                    <!-- ===================== -->
                    <div v-else-if="item.type === 'pdf'" class="d-flex flex-column gap-2">
                    ...
                    <!-- DOCX -->
                    <!-- ===================== -->
                    <div v-else-if="item.type === 'docx'" class="d-flex flex-column gap-2">
                      <div class="d-flex align-items-center gap-2">
